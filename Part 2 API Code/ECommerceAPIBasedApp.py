...
def view_cart():
    ...
    response_data = {"cart_items": cart_items, "total_amount": total_amount}
...
def add_to_cart():
    ...
    # Add the product to the user's cart or
...
@app.route("/search_producut/all/<string:query>", methods=["GET"])
def search_product_by_query(query: str):
    results = [
        product
        for product in products
